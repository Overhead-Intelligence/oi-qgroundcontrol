...
// OI override of src/Toolbar/SelectViewDropdown.qml: identical to stock except the Settings
// entry uses the OI logo mark. The coloredsvg image provider bypasses the URL interceptor,
// so the stock /res/QGCLogoWhite.svg cannot simply be replaced by resource name.
    ...
    contentComponent: Component {
        GridLayout {
            ...
            SubMenuButton {
                ...
                Layout.fillWidth: true
                text: qsTr("Settings")
                imageResource: "/custom/OILogoMark.svg"   // OI override: the settings entry shows the OI mark (see custom/README.md)
